...
function App() {
  return (
    <Routes>
      ...
      <Route
        path="/profile/:id/task/:patientid"
        element={<Task></Task>}
      ></Route>
      ...
      <Route
        path="/profile/:id/profilerequest/:requestid"
        element={<Profilerequest></Profilerequest>}
      ></Route>
      <Route
        path="/profile/:id/profiletask/:taskid"
        element={<Taskspecification></Taskspecification>}
      ></Route>
    </Routes>
  );
}

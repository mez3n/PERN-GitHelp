...
class Service {
  ...
  static async updateServiceEndDate(service_id, eid, event_owner_id, endDate) {
    const result = await pool.query(
      "SELECT update_service_end_date($1,$2,$3,$4) AS result;",
      [service_id, endDate, eid, event_owner_id]
    );
